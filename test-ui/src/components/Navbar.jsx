    ...
    return (
        <>
            ...
            <div className='flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full'>
                <a href="javascript:void(0)" className="max-sm:hidden"><img src={logourl} alt="logo" className='w-[134px]' />
                </a>
                <a href="javascript:void(0)" className="hidden max-sm:block"><img src={logourl} alt="logo" className='w-8' />
                </a>
                ...
                <ul
                    ...
                    <a href="javascript:void(0)"><img src={logourl} alt="logo" className='w-36' />
                    </a>
                    </li>
